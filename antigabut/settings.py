"""
Django settings for antigabut project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'o=bj3z$r)7-)-vf)*t30r-w8a!+o903v813d)3^ncjdi!)j^m5')
...
WSGI_APPLICATION = 'antigabut.wsgi.application'
